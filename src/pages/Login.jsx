    ...
    return (
        <div className='min-h-lvh md:min-h-screen bg-contain bg-left bg-no-repeat relative' style={{ backgroundImage: `url(${shape1})` }}>
            ...
            <div className='container mx-auto min-h-screen p-8 md:p-24 flex flex-col-reverse lg:flex-row items-center justify-between'>
                {/* Left Part */}
                <div>
                    <h1 className='text-sky-700 text-2xl md:text-4xl lg:text-6xl font-extrabold font-audiowide text-center lg:text-left'>xm<span className='text-primary'>ee</span></h1>
                ...
                <div className="min-w-full md:min-w-md">
                    <fieldset className="fieldset">
                        <h3 className='text-slate-400 font-semibold text-lg md:text-2xl font-audiowide mb-4 text-center'>Login with <span className='text-primary'>Email</span></h3>
                        ...
                        <button className="bg-primary hover:bg-slate-500 text-white hover:cursor-pointer text-xs md:text-base rounded-xl mt-4 p-3 md:p-4">Sign In</button>
                    </fieldset>
